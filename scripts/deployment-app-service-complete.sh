...
az deployment sub create --location ${AZURE_LOCATION} --template-file ./deployment-rg.bicep --parameters name=${AZURE_LOG_ANALYTICS_WRKSPC_RESOURCE_GROUP} resourceTags="${AZURE_RESOURCE_TAGS}"

az deployment group create --resource-group ${AZURE_LOG_ANALYTICS_WRKSPC_RESOURCE_GROUP} --template-file ./deployment-logs.bicep \
...
az deployment group create --resource-group ${AZURE_RESOURCE_GROUP} --template-file ./deployment-mi.bicep \
              --parameters  location=${AZURE_LOCATION}  \
                            logAnalyticsWorkspaceName=${AZURE_LOG_ANALYTICS_WRKSPC_NAME}  \
